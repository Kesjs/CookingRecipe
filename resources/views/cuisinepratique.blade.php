        ...
        <div class="container mt-5">
            <div class="bg-white p-5 rounded shadow-lg min-vh-100 mb-5">
                ...
                <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <div class="dropdown">
                        <button class="btn   text-black rounded dropdown-toggle" type="button" data-bs-toggle="dropdown" >
                            Recettes de cuisine
                        </button>
                    ...
                    <div class="dropdown">
                        <button class="btn nav-link active px-2 bg-danger text-white rounded dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Cuisine pratique
                        </button>
                        <ul class="dropdown-menu">
