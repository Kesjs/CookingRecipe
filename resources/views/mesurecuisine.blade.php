            ...
            <div class="bg-white p-5 rounded shadow-lg min-vh-100 mb-5">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle  active bg-danger text-white px-2 rounded" href="#" id="navbarDropdownCuisinePratique" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Cuisine pratique
                                    </a>
                ...
                <nav style="background-color: #fff9db; margin-top: 20px" aria-label="breadcrumb" class="p-2">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mesures et équivalences pour la cuisine</li>
                    </ol>
                </nav>
